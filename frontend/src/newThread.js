...
export function NewComment() {
  ...
  return (
    <div className="container mx-auto bg-bGround max-w-lg  shadow border p-4 m-5 border-none text-center">
      ...
      >
        <label className="text-lightText text-center ">Alias</label>
        <br></br>
        <textarea
          type="text"
          rows="1"
        ...
        />
        <br></br>
        <label className="text-lightText text-center">Body</label>
        <br></br>
        <textarea
          type="text"
          rows="2"
  ...
  return (
    <div className="container mx-auto bg-bGround max-w-lg  shadow border p-4 m-5 border-none text-center">
      <form
        ...
        onSubmit={handleSubmit}
      >
        <label className="text-lightText text-center ">Reply to</label>
        <br></br>
  ...
  return (
    <div className="container mx-auto bg-bGround max-w-lg  shadow border p-4 m-5 border-none text-center">
      <form
        ...
        className="bg-baseObj m-2 border-double border-2 border-darkText mx-auto my-7 max-w-[400px] "
        onSubmit={handleSubmit}
      >
        <label className="text-lightText text-center">Title</label>
        <br></br>
        <textarea
          type="text"
          rows="3"
        ...
        />
        <br></br>
        <label className="text-lightText text-center">Image (Optional)</label>
        <br></br>
        <br></br>
